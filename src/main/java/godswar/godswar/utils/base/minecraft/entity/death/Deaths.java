package godswar.godswar.utils.base.minecraft.entity.death;

import com.google.common.collect.ImmutableMap;
import godswar.godswar.utils.base.language.korean.KoreanUtil;
import godswar.godswar.utils.base.language.korean.KoreanUtil.Josa;
import godswar.godswar.utils.base.random.Random;
import godswar.godswar.utils.library.Entities;
...
public class Deaths {
	...
	static {
		...
		builder.put(DamageCause.ENTITY_ATTACK, new Messages() {
			...
			@Override
			public String getMessage(Player dead, EntityDamageEvent damageEvent) {
	...
	private static Entity getDamager(final EntityDamageEvent damageEvent, final boolean shooter) {
		if (damageEvent instanceof EntityDamageByEntityEvent) {
			final EntityDamageByEntityEvent damageByEntityEvent = (EntityDamageByEntityEvent) damageEvent;
	...
	public static String getMessage(final Player dead) {
	...
	private interface Messages {
		String getMessage(final Player dead, final EntityDamageEvent damageEvent);
	}
