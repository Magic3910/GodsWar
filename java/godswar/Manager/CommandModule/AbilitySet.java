...
import com.magical.Utility.CodeHelper;
import com.magical.Utility.PermissionChecker;
import com.magical.Utility.RandomNumberConstructor;
...
import static com.magical.Utility.RandomNumberConstructor.CanlistDump;
import static com.magical.Utility.RandomNumberConstructor.ndl;
...
public class AbilitySet
{
    ...
    private static void RandomAssignment(CommandSender p, GodsWar t)
    {
        ...
        for (Player e:playerlist)
        {
            ...
            CanlistDump.remove(CanlistDump.indexOf(rn[i]));
            i++;
        }
        Rn();
