package godswar.godswar.Ability;
...
public class Ability
{
    ...
    public final Material co=Material.COBBLESTONE;
    public final Material st=Material.BLAZE_ROD;
    ...
    public Ability(String playerName, String abilityName, int abilityCode, boolean activeType,
                   boolean passiveType, boolean buffType, String[] des)
    {
