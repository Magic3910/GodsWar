...
public class Gradient implements Iterable<RGB> {
	...
	public Gradient(final RGB start, final RGB end, final int colors) {
		this.start = start;
		this.end = end;
		setColors(colors);
	}

	public Gradient(final RGB start, final RGB end) {
		this(start, end, 5);
	}

	public Gradient setStart(RGB start) {
		this.start = start;
		return this;
	}

	public Gradient setEnd( RGB end) {
		this.end = end;
		return this;
	}
